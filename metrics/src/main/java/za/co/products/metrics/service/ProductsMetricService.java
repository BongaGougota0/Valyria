...
@Service
public class ProductsMetricService {

    private RedissonReactiveClient client;
    private Sinks.Many<Integer> sink;

    public ProductsMetricService(RedissonReactiveClient client) {
        this.client = client;
    ...
    public void addProductView(int productId) {
