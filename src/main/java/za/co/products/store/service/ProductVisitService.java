...
public class ProductVisitService {
    ...
    private void init(){
        this.sink
                .asFlux()
                .buffer(Duration.ofSeconds(3)) //list (1,2,35,65,23,)
    ...
    private Mono<Void> updateBatch(Map<Integer, Long> map) {
        ...
        RScoredSortedSetReactive<Integer> set = batch.getScoredSortedSet("product:visit" + format, IntegerCodec.INSTANCE);// key name
