...
public class Syrax extends DragonInt implements DragonRegion, Dragon{
	...
	private int age;
	private String dragonGender = "Hermaphrodite";
	private String dragonMatingRegion;
	...
	private String dragonMatingRegion() {
		return ((this.age <= 12) ? "Westeros" : "Valyria");
	}
	
	private String dragonGender() {
		return this.dragonGender;
	}
	
	private void setDragonGender(String dragonGender) {
		this.dragonGender = dragonGender;
	}
